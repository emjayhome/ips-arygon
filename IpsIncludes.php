...
if (@constant('IPS_BASE') == null) { // Check whether already defined
{
    ...
    define('OM_CHANGEDISABLED', IPS_OBJECTMESSAGE + 15);    // Usage has Changed
    ...
    // SEARCH MANAGER
    define('IPS_SEARCHMESSAGE', IPS_BASE + 510);            // Instance Manager Message
    define('IM_SEARCHSTART', IPS_SEARCHMESSAGE + 1);        // Search was started
    define('IM_SEARCHSTOP', IPS_SEARCHMESSAGE + 2);         // Search was stopped
    define('IM_SEARCHUPDATE', IPS_SEARCHMESSAGE + 3);       // Search has new results
    ...
    // EVENT MANAGER
    define('IPS_EVENTMESSAGE', IPS_BASE + 800);             // Event Manager Message
    ...
    // FLOW MANAGER
    define('IPS_FLOWMESSAGE', IPS_BASE + 1100);             // Flow Manager Message
